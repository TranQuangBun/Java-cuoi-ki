...
public class main_gd extends JFrame{
    ...
    JButton resetButton = new JButton("HỦY BỎ");
...
//head title
         TitledBorder tbdpnall= BorderFactory.createTitledBorder(bd, "QUẢN LÝ THÍ SINH THI VÀO LỚP 10 TRƯỜNG THPT ĐÀO DUY TỪ ");
